...
class ProfileSettings extends Component
{
    ...
    public function mount()
    {
        ...
        // If missing, create a new one so the system doesn't break
        if (!$userAccountSetting) {
            $userAccountSetting = new \App\Models\UserAccountSetting();
            $userAccountSetting->user_id = $this->userId;
            $userAccountSetting->verification = null;
            $userAccountSetting->verification_reject_reason = null;
            $userAccountSetting->show_image = null;
            $userAccountSetting->hourly_rate = null;
        ...
        // Safe access using null coalescing
        $verification                   = $userAccountSetting->verification ?? null;
        $this->verify_reject_reason     = $userAccountSetting->verification_reject_reason ?? null;
        $this->account_settings['show_image'] = $userAccountSetting->show_image ?? null;
        $this->account_settings['hourly_rate'] = $userAccountSetting->hourly_rate ?? null;
