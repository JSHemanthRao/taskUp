...
class AuthService {
    ...
    public function registerUser($request): User {
        ...
        $profile->slug = Str::slug($first_name.' '.$last_name.' '.$user->id);
            ...
            foreach($email_template as $template){
                ...
                if($template->role == 'admin'){
                    ...
                    try {
                        ...
                        \Illuminate\Support\Facades\Log::error("Registration Email (Admin) failed: " . $e->getMessage());
                    ...
                    try {
                        ...
                        \Illuminate\Support\Facades\Log::error("Registration Email (User) failed: " . $e->getMessage());
                        $error_msg = $e->getMessage();
                    }
                }
            }
